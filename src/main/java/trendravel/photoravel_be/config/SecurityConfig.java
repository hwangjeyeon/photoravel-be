...
import trendravel.photoravel_be.common.authentication.security.accessHandler.JwtAccessDeniedHandler;
import trendravel.photoravel_be.common.authentication.security.entryPoint.JwtAuthenticationEntryPoint;
...
import trendravel.photoravel_be.common.authentication.service.PhotographerAuthenticationService;
import trendravel.photoravel_be.common.authentication.token.service.TokenService;
import trendravel.photoravel_be.common.authentication.security.filter.JwtMemberAuthenticationFilter;
import trendravel.photoravel_be.common.authentication.security.filter.JwtExceptionFilter;
import trendravel.photoravel_be.common.authentication.security.filter.JwtPhotographerAuthenticationFilter;
        ...
        return http
                ...
                .cors(custom -> custom.configurationSource(new CorsConfigurationSource() {
                    ...
                    public CorsConfiguration getCorsConfiguration(HttpServletRequest request) {
                        ...
                        config.setAllowedOrigins(List.of("http://photoravel-fe.s3-website.ap-northeast-2.amazonaws.com", "http://localhost"));
